...
localizations_fin = {
    ...
    "search_courses_button": "Etsi ratoja",
    "create_round_button": "Lisää kierros",
    "find_round_button": "Etsi kierros",
    "all_rounds_header": "Tulevat kierrokset",
    ...
    "no_upcoming_rounds_message": "Ei tulevia kierroksia.",
    "no_upcoming_rounds_message_2": "tai",
    "no_rounds_course_link": "luo uusi rata",
    "no_rounds_round_link": "luo uusi kierros",
    "no_search_results_message": "Haullasi ei löytynyt kierroksia. Muuta hakuparametreja ja kokeile uudelleen.",
    "round_view_score_board_header": "Tulokset",
    "hole_view_score_board_header": "Tilanne",
    "hole": "väylä",
    "total_header": "Yhteensä",
    "over_under_header": "+/-",
